...
function resetChess()
{
	for(var i=1,j=0,k=8,l=0,m=8;i<=8;i++,j++,k++,l++,m++)
	{
		document.getElementById((10+i).toString()).appendChild(document.getElementById(whiteSet[j]));
		document.getElementById((20+i).toString()).appendChild(document.getElementById(whiteSet[k]));
		document.getElementById((70+i).toString()).appendChild(document.getElementById(blackSet[l]));
		document.getElementById((80+i).toString()).appendChild(document.getElementById(blackSet[m]));
	}
	chance="whiteset";
}
